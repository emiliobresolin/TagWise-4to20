...
exports.AssignedWorkPackageRepository = void 0;
class AssignedWorkPackageRepository {
    database;
    constructor(database) {
        this.database = database;
    }
    async upsertSeedPackage(record) {
    ...
    async listAssignedSummariesForUser(userId) {
...
function mapAssignedWorkPackageSummaryRow(row) {
    return {
        id: row.id,
